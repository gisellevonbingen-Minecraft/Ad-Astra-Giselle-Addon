...
public class AdAstraGiselleAddonClientForge
{
	public AdAstraGiselleAddonClientForge()
	{
		...
		fml_bus.addListener((RegisterKeyMappingsEvent e) -> AddonClientKeyBindings.register(e::register));
		forge_bus.addListener((TickEvent.ClientTickEvent e) ->
		{
			if (e.phase == TickEvent.Phase.START)
				AddonClientKeyBindings.updateKeys();
		});
	}
