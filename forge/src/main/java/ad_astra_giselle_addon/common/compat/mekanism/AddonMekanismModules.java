...
public class AddonMekanismModules
{
	...
	public static final ModuleRegistryObject<ModuleGravityNormalizingUnit> GRAVITY_NORMALIZING_UNIT = MODULES.register("gravity_normalizing_unit", ModuleGravityNormalizingUnit::new, () -> AddonMekanismItems.GRAVITY_NORMALIZING_UNIT.get(), m -> m.rarity(Rarity.RARE));
