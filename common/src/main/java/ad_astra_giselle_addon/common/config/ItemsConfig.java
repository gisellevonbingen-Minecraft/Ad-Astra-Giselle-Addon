...
public final class ItemsConfig
{
	...
	public static long OXYGEN_CAN_FLUID_CAPACITY = FluidHooks2.BUCKET / 2;
	@ConfigEntry(id = OXYGEN_CAN_ID + "_fluid_transfer", type = EntryType.LONG, translation = OXYGEN_CAN_PREFIX + "_fluid_transfer")
	public static long OXYGEN_CAN_FLUID_TRANSFER = FluidHooks2.BUCKET / 8;
	...
	public static long NETHERITE_OXYGEN_CAN_FLUID_CAPACITY = FluidHooks2.BUCKET;
	...
	public static long NETHERITE_OXYGEN_CAN_FLUID_TRANSFER = FluidHooks2.BUCKET / 4;
}
